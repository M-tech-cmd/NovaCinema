# 🍿 NovaCinema —  Movie Booking System

NovaCinema is a production-ready Movie Ticket Booking Web Application built using the MERN Stack (MongoDB, Express.js, React.js, Node.js). The platform allows users to browse movies, select showtimes, book seats in real time, and complete secure payments — similar to modern cinema booking platforms.
