...
export const navbarStyles = {
  ...
  nav: {
    ...
    scrolled: "py-3 bg-black/85 backdrop-blur-sm shadow-md rounded-lg",
  ...
  logoIconContainer: "bg-transparent p-2 rounded-full border border-red-600/20",
  logoIcon: "h-6 w-6 text-red-500",
  logoText: "text-lg md:text-base font-semibold text-white tracking-tight",

  // Desktop navigation
  desktopNav: "hidden lg:flex absolute left-1/2 transform -translate-x-1/2 z-10 items-center bg-black/50 backdrop-blur-sm rounded-full px-2 py-1 gap-2 shadow-sm",
  ...
  tabletNavLink: {
    base: "nav-pill-btn flex items-center gap-2 px-3 py-2 rounded-full text-sm font-medium transition-all",
    active: "bg-red-700/20 text-white",
    inactive: "text-gray-300 hover:text-white"
  },
  tabletNavIcon: "h-5 w-5",
  tabletNavText: "text-sm font-medium",

  // Auth section
  authSection: "flex items-center gap-2",
  desktopAuth: "hidden md:block",
  logoutButton: "flex items-center gap-2 md:px-3 px-3 py-2 rounded-full bg-gray-800 text-white text-sm font-semibold border border-gray-700",
  loginButton: "flex items-center gap-2 px-3 py-2 rounded-full bg-red-600 text-white text-sm font-semibold border border-red-700",
  authIcon: "h-5 w-5",

  // Mobile menu
  mobileMenuToggle: "md:hidden",
  mobileMenuButton: "p-2 rounded-full bg-black/40 text-gray-200 hover:text-red-400",
...
export const navbarCSS = `
  .pill-border {
    ...
    pointer-events: none;
    background: linear-gradient(90deg, rgba(255,59,59,0.06), rgba(255,87,87,0.03));
    transform: scaleX(0);
  ...
  .pill-underline {
    ...
    border-radius: 999px;
    margin-top: 4px;
    background: linear-gradient(90deg, rgba(255,107,107,0.9), rgba(255,59,59,0.9));
    transform: scaleX(0);
    transform-origin: left center;
    transition: transform 0.22s ease;
  }
...
export const moviesPageStyles = {
  ...
  categoriesFlex: "flex gap-4 overflow-x-auto whitespace-nowrap scrollbar-hide px-4 py-2",
  categoryButton: {
    base: "px-6 py-3 rounded-full cursor-pointer transition-all duration-300 flex-shrink-0 inline-block",
