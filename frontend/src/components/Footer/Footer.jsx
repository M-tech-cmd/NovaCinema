    ...
    <footer className={footerStyles.footer}>
      ...
      <div className={footerStyles.mainContainer}>
        <div className={footerStyles.gridContainer}>
          ...
          <div className={footerStyles.brandContainer}>
            <div className={footerStyles.brandLogoContainer}>
              ...
              >
                Nova<span className={footerStyles.brandTitleWhite}>Cinema</span>
              </h2>
            </div>
            <p className={footerStyles.brandDescription}>
              Experience the every side of cinema with the latest news, reviews, and exclusive content.
            </p>
          ...
          <div>
            ...
            <ul className={footerStyles.contactList}>
              <li className={footerStyles.contactItem}>
                ...
                <span className={footerStyles.contactText}>novacinema@gmail.com</span>
              </li>
              <li className={footerStyles.contactItem}>
                <div className={footerStyles.contactIconContainer}>
                  <Phone className={footerStyles.contactIcon} />
                </div>
                <span className={footerStyles.contactText}>+254 758247543</span>
              </li>
              <li className={footerStyles.contactItem}>
                <div className={footerStyles.contactIconContainer}>
                  <MapPin className={footerStyles.contactIcon} />
                </div>
                <span className={footerStyles.contactText}>Nairobi, Kenya</span>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className={footerStyles.bottomBar}>
          {/* Center: Designed by (plain text) + M-tech-cmd (link only) */}
          <div className={footerStyles.designedBy}>
            <span className={footerStyles.designedByText}>Copyright 2026 @M-tech-cmd All Rights Reserved.</span>
          </div>
