...
const SignUpPage = () => {
  ...
  const validateForm = () => {
    ...
    // role never empty but validate anyway
    if (!formData.role) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const payload = {
        ...
        role: formData.role, // <-- SEND NEW FIELD
          ...
          <div className={signUpStyles.cardContent}>
            ...
            <form onSubmit={handleSubmit} className={signUpStyles.form}>
              ...
              <div className={signUpStyles.formGrid}>
                {/* Email */}
                <div>
                  <label className={signUpStyles.field}>EMAIL</label>
                  <div className={signUpStyles.inputContainer}>
                    <input
                      name="email"
                      type="email"
                ...
                {/* Phone */}
                <div>
                  <label className={signUpStyles.field}>PHONE</label>
                  <div className={signUpStyles.inputContainer}>
                    <input
                      name="phone"
                      type="tel"
              ...
              {/* Row 3: Birth Date + Role + Password */}
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                {/* NEW FIELD: ROLE */}
                <div>
                  <label className={signUpStyles.field}>ACCOUNT ROLE</label>
                  <div className={signUpStyles.inputContainer}>
                    <select
                      name="role"
                      value={formData.role}
                  ...
                  {errors.role && (
                    <p className={signUpStyles.errorText}>{errors.role}</p>
                  )}
                </div>
