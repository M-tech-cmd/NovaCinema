    ...
    >
      <div className={navbarStyles.container}>
        ...
        <div className={navbarStyles.logoContainer}>
          ...
          <div className={navbarStyles.logoText}>NovaCinema</div>
        </div>

        {/* Desktop Center Navigation (1024px+) — icons removed */}
        ...
        <div className={navbarStyles.rightSection}>
          {/* Tablet Navigation (768–1023px) — icons removed */}
        ...
        {/* Mobile Menu Panel — icons kept here for usability */}
        {isMenuOpen && (
          <div
            ref={menuRef}
