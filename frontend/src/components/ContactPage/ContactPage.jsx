...
const ContactPage = () => {
  ...
  const handleSubmit = (e) => {
    ...
    window.open(`https://wa.me/254758247543?text=${whatsappMessage}`, '_blank');
  };
              ...
              <form onSubmit={handleSubmit} className={contactStyles.form}>
                <div className={contactStyles.formGrid}>
                  <div>
                    ...
                    <input
                      ...
                      className={contactStyles.input} placeholder="Your name"
                    />
                  </div>
                  <div>
                    ...
                    <input
                      ...
                      className={contactStyles.input} placeholder="your.email@example.com"
                    />
                  </div>
                </div>
                ...
                <div>
                  ...
                  <input
                    ...
                    className={contactStyles.input} placeholder="Your phone number"
                  />
                </div>

                <div>
                  <label htmlFor="subject" className={contactStyles.inputGroup}>Subject *</label>
                  <select
                ...
                <div>
                  ...
                  <textarea
                    ...
                    rows="4" className={contactStyles.textarea}
                ...
                <div className={contactStyles.contactInfo}>
                  <div className={contactStyles.contactItem}>
                    ...
                    <div>
                      ...
                      <p className={contactStyles.contactDetail}>+254 758 247 543</p>
                    </div>
                  </div>
                  ...
                  <div className={contactStyles.contactItem}>
                    ...
                    <div>
                      ...
                      <p className={contactStyles.contactDetail}>bookings@gmail.com</p>
                      <p className={contactStyles.contactDetail}>support@gmail.com</p>
                    </div>
                  </div>
                  ...
                  <div className={contactStyles.contactItem}>
                    ...
                    <div>
                      ...
                      {/* ✅ Updated location to Kenya */}
                      <p className={contactStyles.contactDetail}>Kimathi Street, Nairobi CBD, Nairobi, Kenya</p>
            ...
            <div className={contactStyles.cardRelative}>
              ...
              <div className={contactStyles.emergencyCard}>
                ...
                <div className="flex items-center">
                  {/* ✅ Updated hotline number */}
                  <div className={contactStyles.emergencyHotline}>
                    HOTLINE: +254 758 247 543
                  </div>
